# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/00_callback.neptune.ipynb (unless otherwise specified).
...
class NeptuneCallback(Callback):
    ...
    def before_fit(self):
        ...
        except NeptuneApiException as e:
            print(f'Neptune experienced an error when creating an experiment: {e}')
